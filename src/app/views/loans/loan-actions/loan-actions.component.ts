  ...
  checkRoute(): void {
    this.router.events.subscribe(() => {
      if(this.router.url.includes('approve')){
        this.pageTitle = "Loan Approval";
        this.action = 'approve';
      }
      if(this.router.url.includes('disburse')){
        this.pageTitle = "Loan Disbursal";
        this.action = 'disburse';
      }
      if(this.router.url.includes('active-view')){
        this.pageTitle = "Active Loans";
        this.action = 'active-view';
      }
      if(this.router.url.includes('closed-view')){
        this.pageTitle = "Closed Loans";
        this.action = 'closed-view';
      }
      if(this.router.url.includes('repayment-approval')){
        this.pageTitle = "Loan Manual Repayments";
        this.action = 'repayment-approval';
      }
